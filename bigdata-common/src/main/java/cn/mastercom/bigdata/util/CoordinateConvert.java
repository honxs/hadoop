    ...
    // WGS84=》GCJ02   地球坐标系=>火星坐标系
        ...
        public static void main(String[] args) throws Exception
        {
        	{ 
        		...
        		double[] dd3 =  bd092WGS(22.544685,113.927827) ;
        		System.out.println(dd3[1] + "," + dd3[0]);
        		
        		dd3 =  wgs2GCJ(dd3[0], dd3[1]) ;
        		System.out.println(dd3[1] + "," + dd3[0]);
        		
        		dd3 =  gcj2BD09(dd3[0], dd3[1]) ;
        		System.out.println(dd3[1] + "," + dd3[0]);
        	}  
    		...
    		try 
    		{
				...
				locInfoWriter  = new BufferedWriter(new FileWriter(args[0] + ".dat"));
				String tempString = null;
				
				while ((tempString = reader.readLine()) != null)
				{   				
					try {
						String[] vct = tempString.split(",|\t|\1",-1);
						double[] dd3 =  wgs2BD09( Float.parseFloat(vct[1]) , Float.parseFloat(vct[0]) );
						//dd3 =  gcj2BD09( dd3[0], dd3[1]);
						locInfoWriter.write(tempString + "," + dd3[1] + "," + dd3[0] + "\r\n");
						//locInfoWriter.write(tempString + "," + vct[0] + "," + dd3[0] + "\r\n");
					    //System.out.println("var point = new BMap.Point(" + dd3[1] + "," + dd3[0] + ");"  + "\r\naddMarker(point);");
					    //System.out.println("var point = new BMap.Point(" + dd3[1] + "," + dd3[0] + ");"  + "\r\naddMarker(point);");
					    //break;
					} catch (Exception e) {
