...
public class CalendarEx implements Comparable<CalendarEx> {
	...
	public String toString(int flag) {
		...
		if (flag == 3)
		{
			String str = getYear() + "年" + String.format("%02d", getMonthInt()) + "��"
	...
	public String getDates(){
		String month = String.valueOf(getMonthInt());
		String date = String.valueOf(getDayOfMonth());
		if(getMonthInt()<10){
			month = "0"+month;
			if( getDayOfMonth()< 10){
				date = "0" + date;
		...
		return String.valueOf(getYear()) + month + date;
	}
}
