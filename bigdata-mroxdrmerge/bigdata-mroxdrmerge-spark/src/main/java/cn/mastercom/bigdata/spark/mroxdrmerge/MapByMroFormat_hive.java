...
public class MapByMroFormat_hive implements org.apache.spark.api.java.function.Function<Tuple2<String, Iterable<String>>, SIGNAL_MR_All>
{
	/**
	 * 
	 */
	...
	public MapByMroFormat_hive() throws Exception
	{
	...
	@Override
	public SIGNAL_MR_All call(Tuple2<String, Iterable<String>> tuple) throws Exception
	{
		...
		for (String value : tuple._2)
		{
			...
			mrResult.tsc.imeiTac = getValidValueInt(mrResult.tsc.imeiTac, item.LteSceNBRxTxTimeDiff);
		...
		{
			OutputOneMr(ncLteMap, ncGsmMap, ncTdsMap, mrResult);
		}
		return mrResult;
	}

	private void OutputOneMr(HashMap<String, NC_LTE> ncLteMap, HashMap<String, NC_GSM> ncGsmMap, HashMap<String, NC_TDS> ncTdsMap, SIGNAL_MR_All mrResult)
	{
		// NC LTE
