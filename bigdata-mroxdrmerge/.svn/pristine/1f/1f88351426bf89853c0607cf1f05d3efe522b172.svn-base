...
public class CSGridFreqStatdo_4G  extends AMapStatDo_4G<CSStat_GridFreq>{
	int i,sourceType;
	public CSGridFreqStatdo_4G(int i,ResultOutputer resultOutputer, int sourceType1,int sourceType, int dataType) {
	...
	protected Object[] getPartitionKeys(DT_Sample_4G sample) {
		...
		int tllongitude = (int) ((long) sample.ilongitude / 4000 * 4000);
		int tllatitude = (int) ((long) sample.ilatitude / 3600 * 3600 + 3600);
		int brlongitude = tllongitude + 4000;
		int brlatitude = tllatitude - 3600;
	...
	protected CSStat_GridFreq createFirstStatItem(DT_Sample_4G sample, Object[] keys) {
		int longitude = (int) ((long) sample.ilongitude / 4000 * 4000);
		int latitude = (int) ((long) sample.ilatitude / 3600 * 3600 + 3600);
		int brlongitude = longitude + 4000;
		int brlatitude = latitude - 3600;
		List<NC_LTE> itemList = sample.getNclte_Freq();
