...
public class Stat_BuildCell extends Stat_Build implements IStat_4G,Serializable
{
	public int iEci;
	...
	public static Stat_BuildCell FillData(String[] vals, int pos)
	{
		...
		{
			LOGHelper.GetLogger().writeLog(LogType.error, "Scene_BuildCell filldata error","", e);
		}
		return build;
	}
}
