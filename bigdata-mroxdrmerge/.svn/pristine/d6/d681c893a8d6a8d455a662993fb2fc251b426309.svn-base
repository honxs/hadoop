...
//		getRedisPassword();
	...
	{
		return conf.getValue("httpPath", "").toString();
	}
	...
	{
		return conf.getValue("mwPath", "").toString();
	}
	...
	{
		return conf.getValue("svPath", "").toString();
	}
	...
	{
		return conf.getValue("rxPath", "").toString();
	}
	...
	{
		return conf.getValue("mosPath", "").toString();
	}
	...
	{
		return conf.getValue("dhwjtPath", "").toString();
	}
	...
	{
		return conf.getValue("rtpPath", "").toString();
	}
	...
	{
		return conf.getValue("mgPath", "").toString();
	}
	...
	{
		return conf.getValue("mmePath", "").toString();
	}
	...
	{
		return conf.getValue("imsMoPath", "").toString();
	}
	...
	public String getImsMtPath()
	{
		...
		return conf.getValue("imsMtPath", "").toString();
	}
	...
	{
		return conf.getValue("quaLityPath", "").toString();
	}
	...
	{
		return conf.getValue("UuPath", "").toString();
	}
	...
	{
		return conf.getValue("mdtPath", "").toString();
	}
	public String getMdtPath2()
	{
		return conf.getValue("mdtOtherPath", "").toString();
	}
	public String getMdtPath3() {
		return conf.getValue("mdtRcefPath", "").toString();
	}

	public String getMosShardingPath()
	{
		return conf.getValue("mosShardingPath","").toString();
	}
	...
	public String getMdtHofRlfRcefPath() {
		return conf.getValue("mdtHofRlfRcefPath","").toString();
	}
