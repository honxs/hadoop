...
public class EventDataOutCellGridStat extends BaseStatDo
{
	...
	public int outDealingResultSub()
	{
		for (EventDataOutCellGrid item : dataMap.values())
		{
			...
			{
				LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"EventDataOutCellGridStat.outDealingResultSub Exception",
						"EventDataOutCellGridStat.outDealingResultSub Exception: " + e.getMessage(),e);
			}
		}
	...
	public int outFinalReusltSub()
	{
		for (EventDataOutCellGrid item : dataMap.values())
		{
			...
			{
				LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"EventDataOutCellGridStat.outFinalReusltSub Exception",
						"EventDataOutCellGridStat.outFinalReusltSub Exception: " + e.getMessage(),e);
			}
		}
