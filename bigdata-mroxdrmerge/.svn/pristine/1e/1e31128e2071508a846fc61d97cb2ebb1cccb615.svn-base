 ...
 */
public class CSTenGridStatdo_4G extends AMapStatDo_4G<CSStat_CellGrid>{
	int sourceType;
	public CSTenGridStatdo_4G(ResultOutputer resultOutputer, int sourceType1,int sourceType,int dataType) {
	...
	protected CSStat_CellGrid createFirstStatItem(DT_Sample_4G sample, Object[] keys) {
		...
		CS_CellGrid.doFirstSample(sample,true,true);//doFirstSample(sample,isten,isGrid); 
