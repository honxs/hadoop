 ...
 */
public class AllFreqOutGridStatDO_4G extends OutGridStatDo_4G
{
	private int index = -1;
	
	public AllFreqOutGridStatDO_4G(int index, ResultOutputer resultOutputer, int sourceType, int confidenceType, int dataType)
	{
