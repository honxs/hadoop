 ...
 */
public class CSGridStatdo_4G extends AMapStatDo_4G<CSStat_CellGrid>{
	int sourceType;
	public CSGridStatdo_4G(ResultOutputer resultOutputer, int sourceType1,int sourceType,int dataType) {
	...
	protected Object[] getPartitionKeys(DT_Sample_4G sample) {
		int itllongitude=(int) ((long) sample.ilongitude / 4000 * 4000);
		int itllatitude=(int) ((long) sample.ilatitude / 3600 * 3600 + 3600);
		int ibrlongitude= itllongitude + 4000;
		int ibrlatitude=itllatitude - 3600;
			return new Object[] {sample.cityID,itllongitude,itllatitude,ibrlongitude,ibrlatitude,TimeHelper.getRoundDayTime(sample.itime)};
	}
	...
	protected CSStat_CellGrid createFirstStatItem(DT_Sample_4G sample, Object[] keys) {
		...
		CS_CellGrid.doFirstSample(sample,false,true);//doFirstSample(sample,isten,isGrid); 
