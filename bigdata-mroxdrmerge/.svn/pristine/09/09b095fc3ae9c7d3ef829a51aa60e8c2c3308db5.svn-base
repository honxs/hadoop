...
public class UepStatDeals
{
	...
	public UepStatDeals(ResultOutputer typeResult)
	{
		...
		// YD IN
		YDList.add(new InGridStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM, UepEnum.DataType_UEP_INGRID_MID_YD.getMark()));

		YDList.add(new InGridCellStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM, UepEnum.DataType_UEP_INGRID_CELL_MID.getMark()));
		
		YDList.add(new BuildStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM, UepEnum.DataType_UEP_BUILDING_MID_YD.getMark()));
		
		YDList.add(new BuildCellStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM, UepEnum.DataType_UEP_BUILDING_CELL_MID.getMark()));
		
		YDList.add(new CellStatDO_4G(typeResult, StaticConfig.SOURCE_YD, UepEnum.DataType_UEP_CELL_YD.getMark()));
		
		YDList.add(new MrSampleStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM, UepEnum.DataType_UEP_INSAMPLE_MID.getMark()));
		
		// YD OUT
		YDList.add(new OutGridStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.OM, UepEnum.DataType_UEP_OUTGRID_MID_YD.getMark()));

		YDList.add(new OutGridCellStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.OM, UepEnum.DataType_UEP_OUTGRID_CELL_MID.getMark()));
		
		YDList.add(new MrSampleStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.OM, UepEnum.DataType_UEP_OUTSAMPLE_MID.getMark()));
