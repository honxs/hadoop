...
public class XdrData_WJTDH_BeiJing extends XdrDataBase
{
	...
	public boolean FillData_short(DataAdapterReader dataAdapterReader) throws ParseException, IOException
	{
		try{
			...
			LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"XdrData_WJTDH_BeiJing.FillData_short error:",
					"XdrData_WJTDH_BeiJing.FillData_short error: " + e.getMessage(),e);
		}
		return true;
	}
	...
	public boolean FillData(DataAdapterReader dataAdapterReader) throws ParseException, IOException
	{
		try
		{
			...
			try{
				...
				LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"XdrData_WJTDH_BeiJing.FillData error",
						"XdrData_WJTDH_BeiJing.FillData error: " + e.getMessage(),e);
			}
