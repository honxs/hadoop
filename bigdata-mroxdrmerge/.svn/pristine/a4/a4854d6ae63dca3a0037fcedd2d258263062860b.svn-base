...
public class Stat_Event_BuildCellPos implements Serializable
{
	...
	public static Stat_Event_BuildCellPos fillData(String[] vals, int pos){
		...
		try{
			...
			LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"Stat_Event_BuildCellPos.fillData error",
					"Stat_Event_BuildCellPos.fillData error: " + e.getMessage(),e);
		}
		return buildCellPos;
	}
