...
//		}
	...
	public int outDealingResultSub()
	{
		for (EventDataAreaCellGrid item : dataMap.values())
		{
			...
			{
				LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"EventDataAreaCellGridStat.OutDealingResultSub error",
						"EventDataAreaCellGridStat.OutDealingResultSub error .",e);
			}
		}
	...
	public int outFinalReusltSub()
	{
		for (EventDataAreaCellGrid item : dataMap.values())
		{
			...
			{
                LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"EventDataAreaCellGridStat.outFinalReusltSub error",
                        "EventDataAreaCellGridStat.outFinalReusltSub error .",e);
			}
		}
