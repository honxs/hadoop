...
//				
		...
		public void reduce(CellTimeKey key, Iterable<Text> values, Context context) throws IOException, InterruptedException
		{
			...
			while (iterator.hasNext())
			{
				...
				{
					LOGHelper.GetLogger().writeLog(LogType.error,"MroLableFileReducers reduce error", "MroLableFileReducers reduce error" +
							"the key is: "+key.getDataType()+" the value is:"+value, e);
				}
			}
