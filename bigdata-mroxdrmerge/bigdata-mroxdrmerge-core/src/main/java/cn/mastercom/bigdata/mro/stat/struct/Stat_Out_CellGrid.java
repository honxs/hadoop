...
public class Stat_Out_CellGrid extends Stat_OutGrid implements Serializable
{
	public int iECI;
	...
	public static Stat_Out_CellGrid FillData(String[] vals, int pos)
	{
		...
		{
			LOGHelper.GetLogger().writeLog(LogType.error,"Stat_OutCellGrid filldata error", "", e);
		}
