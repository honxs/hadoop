...
public class MrLocStatDeals
{
	...
	public MrLocStatDeals(ResultOutputer typeResult)
	{
		...
		YDList.add(new InGridStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM,
				MrLocEnum.DataType_MR_INGRID_MID_YD.getMark()));

		YDList.add(new InGridCellStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM,
				MrLocEnum.DataType_MR_INGRID_CELL_MID.getMark()));

		YDList.add(new BuildStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM,
				MrLocEnum.DataType_MR_BUILDING_MID_YD.getMark()));

		YDList.add(new BuildCellStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM,
				MrLocEnum.DataType_MR_BUILDING_CELL_MID.getMark()));

		YDList.add(new CellStatDO_4G(typeResult, StaticConfig.SOURCE_YD, MrLocEnum.DataType_MR_CELL_YD.getMark()));

		YDList.add(new MrSampleStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.IM,
				MrLocEnum.DataType_MR_INSAMPLE_MID.getMark()));

		// YD OUT
		YDList.add(new OutGridStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.OM, MrLocEnum.DataType_MR_OUTGRID_MID_YD.getMark()));

		YDList.add(new OutGridCellStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.OM, MrLocEnum.DataType_MR_OUTGRID_CELL_MID.getMark()));
		
		YDList.add(new MrSampleStatDo_4G(typeResult, StaticConfig.SOURCE_YD, StaticConfig.OM, MrLocEnum.DataType_MR_OUTSAMPLE_MID.getMark()));
