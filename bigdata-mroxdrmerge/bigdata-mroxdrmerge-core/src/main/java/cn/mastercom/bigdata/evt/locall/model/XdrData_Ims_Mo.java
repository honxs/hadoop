...
public class XdrData_Ims_Mo extends XdrDataBase
{
	...
	public boolean FillData_short(DataAdapterReader dataAdapterReader) throws ParseException, IOException
	{
		...
		try
		{
			...
			{
				LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"XdrData_Ims_Mo.fillData_short1 error",
						"XdrData_Ims_Mo.fillData_short1 error: " + e.getMessage(),e);
				return false;
			}
	...
	public boolean FillData(DataAdapterReader dataAdapterReader) throws ParseException, IOException
	{
		try
		{
			...
			{
				LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"XdrData_Ims_Mo.fillData1 error",
						"XdrData_Ims_Mo.fillData1 error: " + e.getMessage(),e);
				return false;
			}
		...
		{
			LOGHelper.GetLogger().writeLog(IWriteLogCallBack.LogType.error,"XdrData_Ims_Mo.fillData error",
					"XdrData_Ims_Mo.fillData error: " + e.getMessage(),e);
			return false;
		}
	}
