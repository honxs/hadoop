...
public class Stat_BuildPos implements IStat_4G,Serializable
{
	public int iCityID;
	...
	public static Stat_BuildPos FillData(String[] vals, int pos)
	{
		int i = pos;
		Stat_BuildPos build = new Stat_BuildPos();
		try
		{
		...
		{
			LOGHelper.GetLogger().writeLog(LogType.error,"Scene_BuildPos filldata error", "", e);
		}
		return build;
	}
