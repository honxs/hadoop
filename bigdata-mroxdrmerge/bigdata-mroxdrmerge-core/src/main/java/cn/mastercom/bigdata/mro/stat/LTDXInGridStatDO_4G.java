 ...
 */
public class LTDXInGridStatDO_4G extends InGridStatDo_4G
{
	private int index = -1;
	
	public LTDXInGridStatDO_4G(int index, ResultOutputer typeResult, int sourceType, int confidenceType, int dataType)
	{
