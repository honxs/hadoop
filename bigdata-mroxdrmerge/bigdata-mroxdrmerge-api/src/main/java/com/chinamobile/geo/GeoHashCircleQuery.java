...
import com.chinamobile.geo.BoundingBox;
import com.chinamobile.geo.GeoHash;
import com.chinamobile.geo.WGS84Point;
import com.chinamobile.geo.VincentyGeodesy;
...
public class GeoHashCircleQuery implements GeoHashQuery, Serializable {
	...
	/**
	 * create a {@link com.chinamobile.geo.GeoHashCircleQuery} with the given center point and a
	 * radius in meters.
	 */
